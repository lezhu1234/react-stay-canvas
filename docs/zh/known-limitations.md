...
- 原生 WebGL2 支持带 depth 的索引三角形 Mesh、不透明 unlit/Lambert 材质、薄层光照 Glass 材质、显式逐顶点法线、环境光，以及每层最多四个方向光。Glass 使用稳定的对象级从远到近排序；相交透明 Mesh、自身重叠、scene-color 折射、纹理、阴影、order-independent transparency 和 WebGL2 区域截图尚未提供。
