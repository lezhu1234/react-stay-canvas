...
export const catalog: ExampleDefinition[] = [
  ...
  },
  {
    ...
    sourcePaths: [
      ...
      "./examples/simple/coordinateSceneModel.ts",
    ],
    group: "Simple",
    order: 9,
    ...
    features: ["Content → View → Client", "Native WebGL2 scene", "PointLight", "Child placement", "e.point", "tools.viewport"],
  ...
  },
  {
    ...
    features: ["Path + Polygon edges", "shape palette", "inline edit", "pan + zoom + fit", "history adapter + JSON"],
